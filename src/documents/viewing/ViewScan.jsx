...
const ViewScan = () => {
  ...
  return (
    <div className='flex justify-start w-full h-full'>
        <div className='flex flex-col bg-white shadow-xl rounded-xl w-[34rem] h-[530px]'>
            ...
            <div className='relative pt-2 ml-14'>
               ...
               >
                        <SiConvertio size={20} className='absolute top-[25%] left-[8%] -translate-1/2'/>
                        OCR
               </button>
            </div>
            </div>
            ...
            <div className='flex flex-row gap-4 pb-10'>
                <div className='px-5 w-full'>
                    ...
                    >
                            <option value disabled>Please select a scanner</option>
            ...
            <div className='flex flex-col'>
                ...
                <div className='px-5'>
                    <span 
                        className='text-[13x] text-black font-semibold'
                    >
            ...
            <div className='flex flex-row gap-4 justify-center pb-2'>
                <div className="bg-[#0972B8] relative text-white cursor-pointer font-semibold py-2 px-4 rounded inline-flex items-center mr-6">
                    ...
                    >
                        <AiOutlineScan size={20} className='mr-2 absolute top-[50%] left-[8%] -translate-y-1/2'/>
                        Scan
                    </button>	
				</div>
            </div>
        </div>
        <div className='flex flex-row gap-4 bg-gray-400 w-full h-auto shadow-xl rounded-xl ml-4'>
